    ...
    : AudioProcessorEditor(p), processor(p)
{
    ...
    InputGainSlider->setRange (0, 2, 0.01);
    ...
    Left_MidPanSlider->setRange (0, 1, 0.01);
    ...
    Right_SidePanSlider->setRange (0, 1, 0.01);
    ...
    StereoWidthSlider->setRange (0, 2, 0.01);
...
<JUCER_COMPONENT documentType="Component" className="MidSideUtilityAudioProcessorEditor"
  ...
  <SLIDER name="Input Gain Slider" id="498de5430f2986bc" memberName="InputGainSlider"
          ...
          max="2.0" int="0.01000000000000000021" style="Rotary" textBoxPos="TextBoxBelow"
  ...
  <SLIDER name="Left/Mid Pan Slider" id="f9bbb89646c32b71" memberName="Left_MidPanSlider"
          ...
          max="1.0" int="0.01000000000000000021" style="Rotary" textBoxPos="TextBoxBelow"
          textBoxEditable="1" textBoxWidth="80" textBoxHeight="20" skewFactor="1.0"
          needsCallback="1"/>
